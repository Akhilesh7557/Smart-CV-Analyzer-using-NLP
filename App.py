...
st.set_page_config(
    ...
    page_icon='C:/Users/akhilesh ahirwar/AI-Resume-Analyzer/App/Logo/recommend.png', )


## Main function run()
def run():
    ## (Logo, Heading, Sidebar etc)
    img = Image.open('C:/Users/akhilesh ahirwar/Downloads/AI-Resume-Analyzer/screenshots/RESUME.png')
    st.image(img)
    ...
    if choice == 'User':
        ...
        if pdf_file is not None:
            ...
            save_image_path = 'C:/Users/akhilesh ahirwar/Downloads/AI-Resume-Analyzer/App/Uploaded_Resumes/' + pdf_file.name
    ...
    ## CODE FOR ABOUT PAGE
        ...
        <p align="justify">
            ...
            <b>Admin -</b> <br/>
            For login use <b>akhilesh</b> as username and <b>akhilesh@123</b> as password.<br/>
    ...
    ## CODE FOR ADMIN SIDE (ADMIN)
        ...
        if st.button('Login'):
            ...
            ## Credentials 
            if ad_user == 'akhilesh' and ad_password == 'akhilesh@123':
